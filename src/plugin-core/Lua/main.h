...
Lua_DECLARE_EXPORTED_FUNCTION(void, LuaInterpreter_execute, LuaCallResult *result, LuaInterpreter *, const char *filename, const void *buffer, size_t size);
Lua_DECLARE_EXPORTED_FUNCTION(void, delete_LuaCallResult, LuaCallResult *);
